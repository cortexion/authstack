...
public class ConsumableController {
        ...
        private void removeAndAddHardcodedConsumables() {
                ...
                hardcodedConsumables.add(
                                new Consumable("Kana", 188.32, 20.25, 0.0, 12.0, 300.0, now.minusDays(0), testUser));
                hardcodedConsumables.add(new Consumable("Riisi, keitetty, suolaa", 101.58, 1.8, 22.44, 0.21, 100.0,
                                now.minusDays(0), testUser));

                hardcodedConsumables.add(
                                new Consumable("Kana", 188.32, 20.25, 0.0, 12.0, 100.0, now.minusDays(1), testUser));
                hardcodedConsumables
                                .add(new Consumable("Riisi-kauraseos", 374.1, 10.87, 69.49, 4.13, 200.0,
                                                now.minusDays(1), testUser));

                hardcodedConsumables.add(
                                new Consumable("Kana", 188.32, 20.25, 0.0, 12.0, 100.0, now.minusDays(2), testUser));
                hardcodedConsumables
                                .add(new Consumable("Riisi-maissikakku", 364.33, 7.45, 73.64, 2.61, 100.0,
                                                now.minusDays(2), testUser));

                hardcodedConsumables.add(
                                new Consumable("Kana", 188.32, 20.25, 0.0, 12.0, 300.0, now.minusDays(3), testUser));
                hardcodedConsumables.add(
                                new Consumable("Riisi, keitetty, suolaa", 101.58, 1.8, 22.44, 0.21, 100.0,
                                                now.minusDays(3), testUser));

                hardcodedConsumables.add(new Consumable("Kana, keitetty, suolaton", 218.97, 23.55, 0.0, 13.95, 190.0,
                                now.minusDays(4), testUser));
                hardcodedConsumables.add(
                                new Consumable("Kananmuna, keitetty", 134.11, 12.61, 0.3, 9.24, 120.0, now.minusDays(4),
                                                testUser));
                hardcodedConsumables
                                .add(new Consumable("Riisi-maissikakku", 364.33, 7.45, 73.64, 2.61, 100.0,
                                                now.minusDays(4), testUser));
                ...
                hardcodedConsumables.add(
                                new Consumable("Kana", 188.32, 20.25, 0.0, 12.0, 300.0, now.minusDays(5), testUser));
                hardcodedConsumables.add(
                                new Consumable("Riisi, keitetty, suolaa", 101.58, 1.8, 22.44, 0.21, 100.0,
                                                now.minusDays(5), testUser));
                ...
                hardcodedConsumables
                                .add(new Consumable("Kanakeitto, perunaa ja kasviksia", 86.28, 8.05, 3.19, 4.45, 300.0,
                                                now.minusDays(7), testUser));

                hardcodedConsumables.add(
                                new Consumable("Kana", 188.32, 20.25, 0.0, 12.0, 100.0, now.minusDays(8), testUser));
                hardcodedConsumables
                                .add(new Consumable("Riisi-maissikakku", 364.33, 7.45, 73.64, 2.61, 200.0,
                                                now.minusDays(8), testUser));
                ...
                hardcodedConsumables.add(
                                new Consumable("Kana", 188.32, 20.25, 0.0, 12.0, 200.0, now.minusDays(10), testUser));
                hardcodedConsumables.add(
                                new Consumable("Riisi-maissikakku", 364.33, 7.45, 73.64, 2.61, 150.0, now.minusDays(10),
                                                testUser));

                hardcodedConsumables.add(
                                new Consumable("Kana", 188.32, 20.25, 0.0, 12.0, 230.0, now.minusDays(11), testUser));
                hardcodedConsumables.add(
                                new Consumable("Riisi-maissikakku", 364.33, 7.45, 73.64, 2.61, 100.0, now.minusDays(11),
                                                testUser));
                ...
                hardcodedConsumables
                                .add(new Consumable("Kana-vuohenjuustopasta, hk via, valmisateria", 122.58, 8.37, 9.85,
                ...
                hardcodedConsumables.add(
                                new Consumable("Kana", 188.32, 20.25, 0.0, 12.0, 230.0, now.minusDays(15), testUser));
                hardcodedConsumables
                                .add(new Consumable("Kanakeitto, perunaa ja kasviksia", 86.28, 8.05, 3.19, 4.45, 200.0,
                                                now.minusDays(15), testUser));

                hardcodedConsumables.add(
                                new Consumable("Kana", 188.32, 20.25, 0.0, 12.0, 330.0, now.minusDays(16), testUser));
                hardcodedConsumables.add(new Consumable("Riisi, keitetty, suolaa", 101.58, 1.8, 22.44, 0.21, 100.0,
                                now.minusDays(16), testUser));

                hardcodedConsumables.add(
                                new Consumable("Kana, keitetty, suolaa", 239.94, 25.8, 0.0, 15.29, 400.0,
                                                now.minusDays(17), testUser));
                hardcodedConsumables
                                .add(new Consumable("Riisi-kauraseos", 374.1, 10.87, 69.49, 4.13, 200.0,
                                                now.minusDays(17), testUser));

                hardcodedConsumables.add(
                                new Consumable("Kana", 188.32, 20.25, 0.0, 12.0, 230.0, now.minusDays(18), testUser));
                hardcodedConsumables.add(new Consumable("Riisi, keitetty, suolaa", 101.58, 1.8, 22.44, 0.21, 100.0,
                                now.minusDays(18), testUser));

                hardcodedConsumables.add(
                                new Consumable("Kana", 188.32, 20.25, 0.0, 12.0, 130.0, now.minusDays(19), testUser));
                hardcodedConsumables
                                .add(new Consumable("Riisi-kauraseos", 374.1, 10.87, 69.49, 4.13, 200.0,
                                                now.minusDays(19), testUser));

                hardcodedConsumables.add(
                                new Consumable("Kana", 188.32, 20.25, 0.0, 12.0, 300.0, now.minusDays(20), testUser));
                hardcodedConsumables.add(new Consumable("Riisi, keitetty, suolaa", 101.58, 1.8, 22.44, 0.21, 100.0,
                ...
                hardcodedConsumables.add(
                                new Consumable("Kana", 188.32, 20.25, 0.0, 12.0, 300.0, now.minusDays(22), testUser));
                hardcodedConsumables.add(new Consumable("Riisi, keitetty, suolaa", 101.58, 1.8, 22.44, 0.21, 100.0,
                                now.minusDays(22), testUser));

                hardcodedConsumables.add(
                                new Consumable("Kana, keitetty, suolaa", 239.94, 25.8, 0.0, 15.29, 300.0,
                ...
                hardcodedConsumables.add(
                                new Consumable("Kana, keitetty, suolaa", 239.94, 25.8, 0.0, 15.29, 300.0,
                                                now.minusDays(24), testUser));
                hardcodedConsumables.add(
                                new Consumable("Riisi-maissikakku", 364.33, 7.45, 73.64, 2.61, 200.0, now.minusDays(24),
                                                testUser));

                hardcodedConsumables.add(new Consumable("Kana, keitetty, suolaton", 218.97, 23.55, 0.0, 13.95, 400.0,
                                now.minusDays(25), testUser));
                hardcodedConsumables.add(
                                new Consumable("Riisi-maissikakku", 364.33, 7.45, 73.64, 2.61, 300.0, now.minusDays(25),
                                                testUser));

                hardcodedConsumables.add(new Consumable("Kana, keitetty, suolaton", 218.97, 23.55, 0.0, 13.95, 200.0,
                                now.minusDays(26), testUser));
                hardcodedConsumables.add(
                                new Consumable("Riisi-maissikakku", 364.33, 7.45, 73.64, 2.61, 200.0, now.minusDays(26),
                                                testUser));

                hardcodedConsumables.add(
                                new Consumable("Kana", 188.32, 20.25, 0.0, 12.0, 400.0, now.minusDays(27), testUser));
                hardcodedConsumables
                                .add(new Consumable("Riisi-kauraseos", 374.1, 10.87, 69.49, 4.13, 200.0,
                                                now.minusDays(27), testUser));
                ...
                hardcodedConsumables.add(
                                new Consumable("Kana", 188.32, 20.25, 0.0, 12.0, 350.0, now.minusDays(29), testUser));
                hardcodedConsumables
                                .add(new Consumable("Riisi-kauraseos", 374.1, 10.87, 69.49, 4.13, 250.0,
                                                now.minusDays(19), testUser));
        ...
        public ResponseEntity<List<DailyConsumables>> getConsumables(HttpServletRequest request) {
                ...
                List<DailyConsumables> dailyConsumablesList = createDailyConsumablesList(startDate, endDate,
                                consumableDTOs);
        ...
        private List<DailyConsumables> createDailyConsumablesList(LocalDateTime startDate, LocalDateTime endDate,
                ...
                for (LocalDate date = startDate.toLocalDate(); !date.isAfter(endDate.toLocalDate()); date = date
                                .plusDays(1)) {
        ...
        public ResponseEntity<Consumable> addConsumable(HttpServletRequest request,
                ...
                consumable.setName(consumable.getName());
                consumable.setEnergyKcal(consumable.getEnergyKcal());
                consumable.setProtein(consumable.getProtein());
                consumable.setCarb(consumable.getCarb());
                consumable.setFat(consumable.getFat());
                consumable.setAmount(consumable.getAmount());
                consumable.setConsumedAt(consumable.getConsumedAt());
        ...
        public ResponseEntity<List<Consumable>> editDates(HttpServletRequest request,
                ...
                for (Consumable existingConsumable : existingConsumables) {
                        if (!editConsumablesRequest.getConsumables().stream()
                                        .anyMatch(consumable -> consumable.getId()
                                                        .equals(existingConsumable.getId()))) {
        ...
        public String userAccess() {
                return "Content for users, moderators and admins.";
        }

        @GetMapping("/mod")
        @PreAuthorize("hasRole('MODERATOR') or hasRole('ADMIN')")
        public String moderatorAccess() {
                return "Content for moderators and admins.";
        }

        @GetMapping("/admin")
        @PreAuthorize("hasRole('ADMIN')")
        public String adminAccess() {
                return "Content for admins only.";
        }
}
